...
- ✅ **[v1.0 — CLI & v1 requirements](./v1.0-ROADMAP.md)** — shipped **2026-05-03** — frozen checklist + reqs + audit artifacts. Phase workspace snapshot: [v1.0-phases](./v1.0-phases/).
- ✅ **v1.1 — Multi-container stream copy** — shipped **2026-05-04** ([v1.1-REQUIREMENTS.md](./v1.1-REQUIREMENTS.md) § Traceability complete **MULTI-01**–**MULTI-13**); gap phases **06–09** closed per [v1.1-MILESTONE-AUDIT.md](./v1.1-MILESTONE-AUDIT.md).

---

## Milestone v1.1 phases

Requirements traceability tabulated in [v1.1-REQUIREMENTS.md](./v1.1-REQUIREMENTS.md) § Traceability.
...
**Status:** Implemented (see [../phases/04-ux-verification-fixtures-regression/](../phases/04-ux-verification-fixtures-regression/)).
...
**Status:** Implemented (**MULTI-13**); see [../phases/05-x265-preferred-video-reencode/](../phases/05-x265-preferred-video-reencode/).
...
**Artifacts:** [../phases/05-x265-preferred-video-reencode/](../phases/05-x265-preferred-video-reencode/)

---

### Phase 06: Gap closure — Phase 01 verification & MULTI-01/02 traceability

**Goal:** Add **Phase 01** `*-VERIFICATION.md`, reconcile **MULTI-01** / **MULTI-02** in [v1.1-REQUIREMENTS.md](./v1.1-REQUIREMENTS.md) (checkboxes + traceability) with evidence from existing implementation and **`bun run verify`**.
...
**Artifacts:** [../phases/06-gap-closure-phase-01-verification-multi-01-02/](../phases/06-gap-closure-phase-01-verification-multi-01-02/)

---

### Phase 07: Gap closure — MULTI-03 feasibility vs requirements

**Goal:** Close audit **unsatisfied** gap: **MULTI-03** text allows **VP9** copy-safe for **WebM and/or Matroska**; code is **WebM-only** for VP9 today. Either narrow archived **v1.1** requirement text / docs to match shipped matrix **or** implement and test a **Matroska** pairing — no silent optimism.
...
**Artifacts:** [../phases/07-gap-closure-multi-03-feasibility-alignment/](../phases/07-gap-closure-multi-03-feasibility-alignment/)
...
**Artifacts:** [../phases/08-gap-closure-phase-03-remux-pipeline-trust/](../phases/08-gap-closure-phase-03-remux-pipeline-trust/)
...
**Artifacts:** [../phases/09-gap-closure-output-verify-trust/](../phases/09-gap-closure-output-verify-trust/)
