...
| fallbackRequired | 6 | The plan needs video re-encoding or another step that requires explicit approval (e.g. pass `--allow-video-reencode` when stream-copy is not possible). |
